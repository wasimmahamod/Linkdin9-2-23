...
const Sinup = () => {
  ...
  return (
    ...
    <h2 className='font-nunito text-2xl lg:text-3xl font-bold text-primary mt-[42px] w-full'>Get started with easily register</h2>
    ...
    :
    <button onClick={handleSubmit} className='w-full lg:w-[497px] bg-[#086FA4] text-white py-5 rounded-3xl mt-[50px] font-nunito text-xl font-medium'>Sign up</button>
    }
