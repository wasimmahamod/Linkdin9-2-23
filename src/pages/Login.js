...
const Login = () => {
  ...
  return (
    <div className='flex justify-center'>
        ...
        <div className='relative mt-[70px] w-full lg:w-[497px]'>
        ...
        {emailerr && 
        <h3 className='bg-red-500 px-2 rounded-b-lg font-nunito text-lg w-full text-left text-white'>{emailerr}</h3>
        }
        <h4 className='font-nunito text-xl text-primary absolute top-[-14px] left-[46px] bg-white px-4'>Email Addres</h4>
        </div>
      
        <div className='relative mt-[40px] w-full lg:w-[497px]'>
        ...
        {passworderr && 
        <h3 className='bg-red-500 px-2 font-nunito text-lg w-full text-left text-white'>{passworderr}</h3>
        }
        ...
        <div className='w-full lg:w-[497px] flex justify-center items-center'>
        <ProgressBar
            height="80"
            width="80"
        ...
        :
        <button onClick={handleSubmit} className='w-full lg:w-[497px] bg-[#086FA4] text-white py-5 rounded-3xl mt-[50px] font-nunito text-xl lg:text-2xl font-medium'>Sign In</button>
        }
