...
const Navbar = () => {
  ...
  return (
    <ContainerL>
        <div className='lg:flex justify-between items-center mb-10 lg:mb-0'>
        <div>
          <Link to='/home'>
            <img className='mx-auto lg:mx-0' src='images/logo.png'/>
          </Link>
        </div>
        <div  className='w-full lg:w-[50%] lg:flex gap-x-7 '>
            <div className='relative mt-3 lg:mt-0'>
            <input onChange={handleSearch} className='w-full lg:w-[367px] py-5 px-16 placeholder:text-[#CECECE]' placeholder='Search'/>
            <BiSearchAlt2 className='text-2xl  absolute top-5 left-5'/>
            </div>
            <div className='flex items-center gap-x-4 w-[330px] mt-3 lg:mt-0'>
