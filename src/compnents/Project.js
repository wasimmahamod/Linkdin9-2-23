...
const Project = () => {
    ...
    return (
        <div className='mt-20 relative'>
            ...
            {projectModal &&
            <div className='w-full h-full  bg-[rgba(0,0,0,.7)] absolute top-0 left-0 lg:flex block justify-center items-center p-5'>
               ...
               <h3 className='font-nunito font-medium text-2xl text-white '>Upload Your Project </h3>
                <input onChange={handleProjectFile} className='font-nunito mt-5 text-xl text-white block w-full' type="file"/>
