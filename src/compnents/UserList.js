...
const UserList = () => {
  ...
  return (
    <div className='mt-5 relative shadow-lg	w-full overflow-y-scroll lg:p-5	'>
    <h2 className='font-nunito font-semibold text-xl mb-4'>User List </h2>
    <input onChange={handleSearch}  className='w-full rounded-xl py-3 lg:pl-5 placeholder:font-poppins text-base drop-shadow-lg	' type="text" placeholder='Search'/>
    <div className='w-full  h-[340px]'>

    {filterUserlist.length==0?
    userList.map((item)=>(
      <div className='flex  w-full items-center lg:gap-x-4  py-3.5 border-b '>
